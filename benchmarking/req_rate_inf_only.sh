...
OUTPUT_FOLDER="../benchmarking/data/req_rate_inf_only"
...
for k in "${!arrival_rates[@]}"; do
    ...
    echo "Running $TRACE_FILE with $MAX_TOKENS_PER_BATCH tokens/batch and 0 bwd layers/step"
    ...
    ./inference/peft/req_rate_benchmark \
        ...
        --num-layers-per-finetuning-step 0 \
