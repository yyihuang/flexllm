...
#SBATCH --job-name=incr_decoding
#SBATCH --output=/global/homes/g/goliaro/flexllm/benchmarking/output/slurm/job_%A_%a.out
#SBATCH --error=/global/homes/g/goliaro/flexllm/benchmarking/output/slurm/job_%A_%a.err
#SBATCH --array=0-69
